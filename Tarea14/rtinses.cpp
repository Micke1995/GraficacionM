...
Color shade(const Ray &r) { //Agregamos la profundidad para hacer una funcion recursiva, esto nos permite lanzar un segundo rayo desde
	...
	troughpout=troughpout*attenuation*(Coseno/continueprob);
...
int main(int argc, char *argv[]) {
	...
	FILE *f = fopen("ImplicitoRuletarusa.ppm", "w");
