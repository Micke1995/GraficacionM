...
double invpi=1.0/pi;
double invrndmx= 1.0/(RAND_MAX + 1.0);

inline double random_double() {
    // Returns a random real in [0,1).
    return rand()*invrndmx ;
	//return dis(gen);
}
...
/////////////////////////////////////////////////////////////////////////////////////////////
 //Volume VolumenHomogeneo(0.0001,0.003);

// Color shade(Ray &r, int prof,int paso){
...
//     Color background = obj.m->Emite(rec.x);
...
//         t_march += stepSize;
//         x_march = r.o + r.d * t_march;
//         transmittanceFromEye = VolumenHomogeneo.TrasmitanciaHomogenea(r.o, x_march);
...
//         double transmittanceFromLight = VolumenHomogeneo.TrasmitanciaHomogenea(x_march, light.getLightPosition());
        
//         Li = Li + transmittanceFromEye * sigmaS * pf * transmittanceFromLight * stepSize;
