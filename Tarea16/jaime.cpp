...
Sphere spheres[] = {
	...
	Sphere(16.5, Point(-23, -24.3, -34.6), Color(1, 1, 1),	     Color(),		  0), // esfera abajo-izq
	Sphere(16.5, Point(23, -24.3, -3.6),   Color(.75, .25, .25), 	 	 Color(),		  0), // esfera abajo-der
	//Sphere(10.5, Point(-26, -30.3, 10),     Color(1, 1, 1), 	 	 Color(),		  0). // esfera abajo-der-atras
