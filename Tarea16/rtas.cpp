...
double pi=3.141592653589793; //Creamos el valor de pi para facilitarnos varais cosas.
...
public:
	...
	Point p;	// posicion 
	material *m;	// Material de la esfera ****Proyecto 2*******
...
Color shade(const Ray &r,int prof) {
    ...
    return emite + attenuation.mult(shade(rebota, prof-1))*(Coseno/(pw)); 
